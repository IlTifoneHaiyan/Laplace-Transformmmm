...
class ltSim {
    ...
    updateMilestones() {
        ...
        else
        {
            ...
            if(this.maxRho > 4 && this.timer > this.timerCap)
            {
                this.timer = 0;
    ...
    simulate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (!pubCondition) {
                ...
                this.buyVariables();
                pubCondition = (global.forcedPubTime !== Infinity ? this.t > global.forcedPubTime : this.t > this.pubT * 2 || this.pubRho > this.cap[0] || this.curMult > 15) && this.pubRho > 7;
                this.ticks++;
            }
    ...
    tick() {
        ...
        if(this.laplaceActive && this.variables[5].lvl > 0) {
            ...
            this.lambda = this.getQS() * (0.3 + 0.04 * this.milestones[1]);
        }
        else {
            ...
            this.rho = add(this.rho, bonus + this.variables[0].value * (1 + 0.05 * this.milestones[0]) + this.variables[1].value + this.lambda + q);
        }
