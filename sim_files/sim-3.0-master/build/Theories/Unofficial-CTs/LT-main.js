...
class ltSim {
    ...
    getBuyingConditions() {
        const conditions = {
            "LT-30/30": Array(this.variables.length).fill(true),
            "LT-2/2": [
            ...
            "LT-2/240": Array(this.variables.length).fill(true),
        };
    ...
    getMilestoneTree() {
        ...
        const tree = {
            "LT-30/30": globalOptimalRoute,
            "LT-2/2": globalOptimalRoute,
            "LT-2/240": globalOptimalRoute,
        };
