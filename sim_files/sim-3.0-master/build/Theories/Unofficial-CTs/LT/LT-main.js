...
import Variable, { ExponentialCost, CompositeCost, SuperExponentialCost } from "../../../Utils/variable.js";
...
class ltSim {
    ...
    getMilestoneConditions() {
        return [
            ...
            () => this.laplaceActive == false,
            () => this.laplaceActive == false,
            () => this.laplaceActive == false && this.variables[3].level < 600,
    ...
    updateMilestones() {
        ...
        if (this.variables[6].varBase !== this.initialLambdaBase * Math.pow(10, this.milestones[2]) + 100 * this.milestones[3]) {
            this.variables[6].varBase = this.initialLambdaBase * Math.pow(10, this.milestones[2]) + 100 * this.milestones[3];
    ...
    tick() {
        ...
        if (this.laplaceActive) {
            ...
            this.currencies[0] = add(this.currencies[0], bonus + this.variables[0].value * (1 + 0.05 * this.milestones[0]) + this.variables[1].value + (this.variables[6].value) * (1 + 0.05 * (this.variables[7].level))
