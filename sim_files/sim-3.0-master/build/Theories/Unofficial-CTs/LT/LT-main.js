...
class ltSim {
    ...
    updateMilestones() {
        ...
        if (this.variables[6].varBase !== this.initialLambdaBase * Math.pow(10, this.milestones[2])) {
            this.variables[6].varBase = this.initialLambdaBase * Math.pow(10, this.milestones[2]);
